            ...
            if(isset($_POST['submit']))
            {
             ...
             /*  if(empty($_POST['D_ID']))
               ...
               if(empty($_POST['PD_ID']))
                {
                    $errPD_ID="*Patient ID Required";
                    $has_error=true;
                }
                else
                {			
                    $PD_ID=htmlspecialchars($_POST['PD_ID']);
                ...
                if(!$has_error)
		        {
                   ...
                   insertTest($MT_ID, $MT_NAME, $MT_TYPE, $MT_DATE, $MT_RESULT, $MT_OBSERVATION, $D_ID, $A_ID, $PD_ID);
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <tr>
					 ...
					 <td>Doctor ID:</td>
                        <td><input type="text" size="10" style="width: 250;" value="<?php echo $D_ID;?>" name="D_ID" readonly></td>
                    </tr>
                   

                    <tr>
                        <td>Assistant ID:</td>
                        <td><input type="text" style="width: 250;"value="<?php echo $A_ID;?>" name="A_ID"></td>
                    </tr>
                     <tr>
                        <td></td>
                        <td><span style="color:red"><?php echo $err_A_ID;?></span></td>
                    </tr>
					
					<tr>
                        <td>Patient ID:</td>
                        <td><input type="text" style="width: 250;"value="<?php echo $PD_ID;?>" name="PD_ID"></td>
                    </tr>
                    <tr>
                        <td></td>
                        <td><span style="color:red"><?php echo $err_PD_ID;?></span></td>
                    </tr>
