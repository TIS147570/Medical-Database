  ...
  <?php
				        foreach($users as $user)
				        {
                            echo "<tr>";
                                ...
                                echo "<td>".$user["U_NID"]."</td>";
                                echo "<td>".$user["U_NAME"]."</td>";
                                
								  echo "<td>".$user["U_EMAIL"]."</td>";
                                echo "<td>".$user["U_GENDER"]."</td>";
                                echo "<td>".$user["HOSPITAL_Location"]."</td>";
                                echo "<td>".$user["U_CONTACT"]."</td>";
                               
                                echo '<td><a href="updateuser.php?id='.$user["U_ID"].'" class="btn1 btn1-success">Edit</a></td>';
                            echo "</tr>";
				        }
                    ?>
...
<script>
	...
	function search(){
		...
		if(text){
			xhttp.open("GET","searchuser.php?key="+text,true);
			xhttp.send();
		}
		else{
